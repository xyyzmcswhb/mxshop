...
func main() {
	...
	dsn := "root:94144325hb@tcp(127.0.0.1:3306)/mxshop_user_srv?charset=utf8mb4&parseTime=True&loc=Local"
	...
	// 迁移 schema
	//_ = db.AutoMigrate(&models.User{}) //此处应该有sql语句
	...
	//cutom options
	options := &password.Options{10, 100, 32, sha512.New} //sha512为更安全的做法
