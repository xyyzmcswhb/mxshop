...
import (
	...
	"io"
	"log"
	models "mxshop_srvs/order_srv/model"
	"os"
	"time"
...
func main() {
	...
	dsn := "root:94144325hb@tcp(127.0.0.1:3306)/mxshop_order_srv?charset=utf8mb4&parseTime=True&loc=Local"
	...
	// 迁移 schema
	_ = db.AutoMigrate(&models.OrderInfo{}, &models.OrderGoods{}, &models.ShoppingCart{}) //此处应该有sql语句
